...
function InformacionCrear({ informacion, setInformacion, onClose }) {
    ...
    const enviarFormulario = (e) => {
        ...
        if (validar()) {
            ...
            servicioInformacion.create(nuevaInformacion)
                .then(response => {
                    Swal.fire("informacion creada correctamente");
                    ...
                    nuevaInformacion.id = response.data.id
                    // Actualizar el estado local de aficiones
                    setInformacion([...informacion, nuevaInformacion]);
                    //Cerramos el modal
                    onClose();
                })
                .catch(error => {
...
export default InformacionCrear;